...
export default async function WeatherWidget() {
  ...
  if (!weatherData) {
    return (
      <div className="profile-widget weather-widget">
  ...
  return (
    <div className="profile-widget weather-widget">
      ...
      <div className="profile-widget__main">
        <span className="profile-widget__icon">
          {getWeatherIcon(weatherData.condition)}
        </span>
        <div>
          <p className="profile-widget__value">
            {Math.round(weatherData.temperature)}°F • {weatherData.condition}
          </p>
          <p className="profile-widget__note">
            Today: {formatTemperatureRange(weatherData)}
          </p>
        </div>
      </div>

      <dl className="profile-widget__list">
        <div>
          <dt>Humidity:</dt>
          <dd>
