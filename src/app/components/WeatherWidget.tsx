...
export default async function WeatherWidget() {
  ...
  if (!weatherData) {
    return (
      <div className="weather-widget frost-panel p-5 text-[var(--u-ink-muted)]">
  ...
  return (
    <div className="weather-widget frost-panel p-5">
      ...
      <dl className="mt-3 space-y-1 text-sm text-[var(--u-ink)]">
