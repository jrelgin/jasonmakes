...
export default async function SpotifyWidget() {
  ...
  if (!trackData) {
    return (
      <div className="profile-widget spotify-widget">
        <p>Music data unavailable</p>
        {spotifyData?.lastUpdated && (
          <p className="profile-widget__updated">
  ...
  return (
    <div className="profile-widget spotify-widget">
      ...
      <div className="profile-widget__main">
        <span className="profile-widget__icon">♪</span>
        <div>
          <p className="profile-widget__value">{trackData.title}</p>
          <p className="profile-widget__note">by {trackData.artist}</p>
          {trackData.trackUrl && (
            <a
